...
export default function RemediesScreen() {
  ...
  const data  = REMEDIES.filter(
    r => r.cat.toLowerCase() === cat.toLowerCase()
  );
  ...
  return (
    <SafeAreaView style={s.safe}>
      <View style={s.header}>
        ...
        <View>
          <Text style={s.headTitle}>{cat}</Text>
...
const s = StyleSheet.create({
  ...
  headSub:   { fontFamily: Fonts.regular, fontSize: 12, color: Colors.text3, marginTop: 2 },
